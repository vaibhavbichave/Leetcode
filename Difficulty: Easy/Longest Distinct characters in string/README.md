<h2><a href="https://www.geeksforgeeks.org/problems/longest-distinct-characters-in-string5848/1?page=1&company=Amazon&difficulty=Easy&status=unsolved&sortBy=submissions">Longest Distinct characters in string</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given a string <strong>S</strong>, find the length of the longest substring with all distinct characters.&nbsp;</span></p>
