<h2><a href="https://www.geeksforgeeks.org/problems/uncommon-characters4932/1?page=1&company=Amazon&difficulty=School,Basic&status=unsolved&sortBy=submissions">Uncommon characters</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given two strings A and B consisting of lowercase english characters. Find the characters that are not common in the two strings.&nbsp;</span></p>
